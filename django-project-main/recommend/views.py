...
from .recommendation import recommend_engine
...
def recommend_new(request):
    ...
    rating_objects = Myrating.objects.all()
    df = pd.DataFrame(list(rating_objects.values()))
    ...
    prediction_matrix, Ymean = recommend_engine()
